...
nos enseñaron a **como escribir en github**, de lo que mas destaco y recuerdo fue poner los titulos con las rayas de gato en un texto, mientras mas rayas mas subtitulos y asi, tambien con los asteriscos se tiene que usar al inicio y despues y tienen que ser dos por lado o tan solo ctrl + B, a separar las cosas con la tecla menos y ponerla 3 veces, se tieen que poner tres veces y solitario en su propia linea, poner imagenes corte p5.js se sube a un repositorio y de ahi mismo se cita al texto para poder mostrarla, tener cuidado con las mayusculas y minusculas en todo momento, a enumerar por asi decirlo con un puntito cada punto, se hace con un asterico y despues espacio, la cursiva de hace cerrando un texto en un solo asterico y por ultimo a como dejar links limpios o poner link en un texto el cual se hace con [ los corchetes y cerrando entre parentesis el link.

---

### Experimentación de circuitos en protoboard en clase
